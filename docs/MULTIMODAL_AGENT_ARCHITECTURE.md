...
- After freezing fusion at `b03156b`, the source-disjoint Q1 2025 PDF transport set covered 85 pages and 14 newly authored caption-derived queries. Text reached MRR/Recall@5 `0.8929/1.00`; Qwen visual and equal-weight fusion both reached `1.00/1.00`, with paired fusion-minus-text MRR interval `0.0000–0.2143`. The source is disjoint from Q4 multimodal development, but labels remain same-author and Q1 2025 was not globally untouched across the entire project.
