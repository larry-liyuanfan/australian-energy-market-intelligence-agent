...
- Explanatory corpus: five AEMO Quarterly Energy Dynamics reports (Q2 2025–Q2 2026) and the AER January–March 2026 significant-price report; **905 chunks** with URL, publication/retrieval times, source hash, size, page count and usage boundary. The SG deployment still serves the earlier 735-chunk five-report index, while the sixth report is reserved for the offline frozen-feature holdout below.
